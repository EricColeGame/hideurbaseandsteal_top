...
const OVERVIEW_LABEL_BY_LOCALE: Record<string, string> = { en: "Overview", es: "Resumen", ja: "一覧", pt: "Visão geral" };

const GROUP_ORDER = ["guide","mechanics","maps","items","controls","community"];
