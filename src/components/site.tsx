  ...
  const header = (
    <div className="flex items-center justify-between gap-4">
      <Link href={localizeHref("/", locale)} className="flex items-center gap-3">
        <div className="relative grid h-9 w-9 place-items-center overflow-hidden rounded-xl border border-border bg-[hsl(var(--nav-theme))] shadow-sm">
          <span aria-hidden="true" className="text-base font-extrabold leading-none text-primary-foreground">{siteConfig.logoText}</span>
        </div>
    ...
    <div className="group relative cursor-pointer overflow-hidden rounded-2xl border border-border shadow-lg transition-all duration-200">
      <div className="relative aspect-video w-full">
        <img
          ...
          alt={`${siteConfig.name} gameplay video preview`}
